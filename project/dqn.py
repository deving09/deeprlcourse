  ...
  def __init__(
    ...
    if True:
        ...
        if self.preload and self.src_task is not None:
            ...
            self.saver.restore(self.session, "/home/dguillory/workspace/homework/models/" + self.src_task +".ckpt")
        """

        base_model = q_func(obs_t_float, self.num_actions, scope="q_func", reuse=False)
